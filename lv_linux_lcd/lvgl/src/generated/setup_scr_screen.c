...
void setup_scr_screen(lv_ui *ui){
	...
	lv_obj_set_pos(ui->screen_counter, 244, 95);
	lv_obj_set_size(ui->screen_counter, 133, 88);
	...
	lv_style_set_text_font(&style_screen_counter_main_main_default, &lv_font_arial_64);
	...
	lv_obj_set_pos(ui->screen_plus, 114, 264);
	lv_obj_set_size(ui->screen_plus, 133, 88);
	...
	lv_style_set_text_font(&style_screen_plus_main_main_default, &lv_font_simsun_16);
	...
	lv_obj_set_pos(ui->screen_minus, 360, 264);
	lv_obj_set_size(ui->screen_minus, 133, 88);
	...
	lv_style_set_text_font(&style_screen_minus_main_main_default, &lv_font_simsun_16);
